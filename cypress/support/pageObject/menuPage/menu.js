...
import * as data from "../../../data/dataTestLogin";
...
class Menu {
    ...
    clickPhoneMenu(){
        cy.get(el.elements.phoneLinkMenuVertical).eq(0).click;
    }

    clickMenu(menu){
        const menuName = ['Home', 'Contact', 'About Us', 'Cart']
        cy.get().eq(menuName[menu]).click()
    }
